const About = () => {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-gray-300">
      {/* Title */}
      ...
      <p className="text-base sm:text-lg mb-8 leading-relaxed tracking-wide">
      ...
      {/* Education */}
      <h3 className="text-xl sm:text-2xl font-semibold text-purple-400 mb-3">🎓 Education</h3>
      <ul className="list-disc list-inside text-sm sm:text-base space-y-1 pl-2">
        <li>
      ...
      <div className="mt-10 flex flex-col sm:flex-row gap-4">
        <a
          ...
          className="w-full sm:w-auto text-center bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-2 rounded-full hover:from-blue-500 hover:to-cyan-400 transition duration-300 shadow-lg shadow-blue-500/30 hover:shadow-cyan-500/40"
        >
          📄 Download CV
        </a>
      </div>
